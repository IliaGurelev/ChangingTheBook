<template>
  <div class="product">
    ...
    <div class="product__info">
      ...
      <button class="product__button" @click="addProduct">Добавить объявление</button>
...
<script setup>
import { ref } from 'vue';
import { addBook, uploadImageToImgBB } from '@/apiService';
...
async function addProduct() {
  ...
  const imageUrl = await uploadImageToImgBB(imageFile.value);
  const productData = {
